...
const alertaGeneral = document.getElementById("alerta-general") as HTMLDivElement;
...
gridUsuarios.addEventListener("click", async (e) => {
    ...
    if (btnBorrar) {
        ...
        if (confirm("Peligro: estas seguro de que quieres dar de baja a este empleado? Esta accion no se puede deshacer")) {
            try {
    ...
    if (btnEditar) {
        ...
        (document.getElementById("modal-nombre-empleado") as HTMLElement).innerText = nick;
        (document.getElementById("modal-id-empleado") as HTMLInputElement).value    = id;
        (document.getElementById("select-nuevo-rol") as HTMLSelectElement).value    = rolActual;
...
document.getElementById("btn-guardar-rol")?.addEventListener("click", async () => {
    const id       = (document.getElementById("modal-id-empleado") as HTMLInputElement).value;
    const nuevoRol = (document.getElementById("select-nuevo-rol") as HTMLSelectElement).value;
